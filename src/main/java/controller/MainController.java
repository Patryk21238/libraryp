...
public class MainController {
    ...
    private void selectProgramAction(int inputNumber, List<UserProfile> userProfiles,
                                     List<Book> books, List<Magazine> magazines, List<Film> films) {
    ...
    private String selectProgramActionMessage =
            "WYBIERZ" +
